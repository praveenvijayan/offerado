...
const DefaultSingleTemplate = ({ offer }: { offer: any }) => {
  ...
  return (
    <div className="single-template bg-white h-full">
      ...
      <Image
        src={
          offerData?.image || "http://dummyimage.com/200x200.png/ff4444/ffffff"
        }
        alt={offerData?.name}
        width={150}
        height={150}
      ...
      <p className="text-sm text-gray-500">SKU: {offerData?.sku}</p>
      <p className="text-sm text-gray-500">Category: {offerData?.category}</p>
      ...
      <p className="text-lg font-semibold text-gray-700">Offer Price:</p>
